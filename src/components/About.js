     ...
     <div className='container mx-auto'>
       <div className='flex flex-col xl:flex-row gap-24'>
          ...
          <div className='flex flex-col items-center text-center lg:items-start lg:text-left'>
            ...
            <p className='mb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt sed iste, sunt quod illum asperiores quisquam optio officia aliquam veniam. <br /> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab, delectus. </p>
            </div>
