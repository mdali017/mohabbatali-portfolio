          ...
          >
            <div className="flex flex-col">
              ...
              <p className="mb-8">
                ...
                applications using the MERN technology stack, which stands for
                MongoDB, Express.js, React.js, and Node.js. I have a strong
                understanding of each component in the stack, allowing me to
                build full-stack applications from the back-end to the
                front-end. <br /> In terms of back-end development, I am
                proficient in working with Node.js and Express.js to create
