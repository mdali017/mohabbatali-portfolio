      ...
      <section className="grid lg:grid-cols-3 gap-y-12 lg:gap-x-8 lg:gap-y-8">
        <div className="border">
          <div className="w-full   ">
            <div className="project-section-style">
              <img className=" img-scroller" src={project4} alt="" />
            </div>
            <h2 className="mt-4">
              Project Name:{" "}
              <span className="text-3xl text-orange-500">Restro Queen</span>
            </h2>
            <p className="mt-5">
            ...
            <div className="mt-5 ">
              <a
                href="https://restro-queen-45b4c.web.app"
                className="mr-5 btn border"
              >
                Live Site{" "}
              </a>
              <a
                href="https://github.com/mdali017/restro-queen-client"
                className="mr-5 btn border"
              >
                Client Site code
              </a>
              <a
                href="https://github.com/mdali017/restro-queen-server"
                className="mr-5 btn border"
              >
                Server Site code
              </a>
        ...
        <div className="border">
          <div className="w-full   ">
            ...
            <h2 className="mt-4">
              Project Name:{" "}
              <span className="text-3xl text-orange-500">vegFoods</span>
            </h2>
            <p className="mt-5">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nisi
              magni recusandae iure eaque corporis deserunt reprehenderit,
              perspiciatis dignissimos adipisci placeat?
            </p>

            <div className="mt-5 ">
              <a
                href="https://zesty-cannoli-f6328d.netlify.app/"
                className="mr-5 btn border"
              >
                Live Site{" "}
              </a>
              <a
                href="https://github.com/mdali017/vegFoods"
                className="mr-5 btn border"
              >
                Client Site code
              </a>
              <a
                href="https://github.com/mdali017/vegFoods-server"
                className="mr-5 btn border"
              >
                Server Site code
              </a>
        ...
        <div className="border">
          <div className="w-full  scroll-m-7 border-1 border-white ">
            ...
            <h2 className="mt-4">
              Project Name:{" "}
              <span className="text-3xl text-orange-500">DreamChef</span>
            </h2>
            <p className="mt-5">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nisi
              magni recusandae iure eaque corporis deserunt reprehenderit,
            ...
            <div className="mt-5 ">
              <a
                href="https://mellow-custard-58dbcf.netlify.app/"
                className="mr-5 btn border"
              >
                Live Site{" "}
              </a>
        ...
        <div className="border">
          <div className="w-full  scroll-m-7 border-1 border-white ">
            ...
            <div className="mt-5 ">
              <a
                href="https://kid-sports-academy.web.app/"
                className="mr-5 btn border"
              >
                Live Site{" "}
              </a>
